...
```bash
helm show values oci://ghcr.io/trianalab/jesse-chart/jesse --version 0.0.9 > values.yaml
```
...
```bash
helm install jesse oci://ghcr.io/trianalab/jesse-chart/jesse --version 0.0.9 --namespace jesse-namespace --create-namespace -f values.yaml
```
