...
![Version: 0.0.4](https://img.shields.io/badge/Version-0.0.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.4.2](https://img.shields.io/badge/AppVersion-1.4.2-informational?style=flat-square)
...
```bash
helm show values oci://ghcr.io/trianalab/jesse-chart/jesse --version 0.0.4 > values.yaml
```
...
```bash
helm install jesse oci://ghcr.io/trianalab/jesse-chart/jesse --version 0.0.4 --namespace jesse-namespace --create-namespace -f values.yaml
```
